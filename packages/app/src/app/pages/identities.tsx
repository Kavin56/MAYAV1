    ...
    <div class="space-y-6 max-w-[680px]">
      ...
      <Show when={!serverReady()}>
        <div class="rounded-xl border border-gray-4 bg-gray-1 p-5">
          <div class="text-sm font-semibold text-gray-12">Connect to a MAYA server</div>
          <div class="mt-1 text-xs text-gray-10">
            Identities are available when you are connected to a MAYA host (<code class="text-[11px] font-mono bg-gray-3 px-1 py-0.5 rounded">maya</code>).
          </div>
        </div>
      </Show>
