...
export default function CreateRemoteWorkspaceModal(props: {
  ...
  /** When true, URL and token are fixed from initialValues; only path and display name are shown/editable. */
  staticUrlAndToken?: boolean;
  submitting?: boolean;
  error?: string | null;
  inline?: boolean;
  showClose?: boolean;
  ...
  const staticMode = () => props.staticUrlAndToken === true && (props.initialValues?.openworkHostUrl?.trim()?.length ?? 0) > 0;
    ...
    <div class="bg-gray-2 border border-gray-6 w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
      ...
      <div class="p-6 flex-1 overflow-y-auto space-y-6">
        ...
        <div class="space-y-4">
          ...
          <TextInput
            ref={staticMode() ? inputRef : undefined}
