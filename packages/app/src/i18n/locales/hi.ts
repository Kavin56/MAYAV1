 ...
 * Contribute at: https://github.com/different-ai/maya/blob/main/packages/app/src/i18n/locales/hi.ts
...
export default {
  ...
  // https://github.com/different-ai/maya/blob/main/packages/app/src/i18n/locales/hi.ts
} as const;
