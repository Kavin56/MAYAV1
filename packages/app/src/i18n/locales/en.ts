...
export default {
  ...
  "onboarding.windows_install_instruction": "Install OpenCode for Windows, then restart MAYA. Ensure opencode.exe is on PATH.",
  ...
  "onboarding.cli_install_commands": "Install OpenCode with one of the commands below, then restart MAYA.",
  ...
  "onboarding.advanced_openwork_host": "MAYA server",
  ...
  "onboarding.run_local_description": "MAYA runs OpenCode locally and keeps your work private.",
