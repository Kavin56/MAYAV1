...
#[derive(Default)]
pub struct MayaServerManager {
    pub inner: Arc<Mutex<MayaServerState>>,
}

#[derive(Default)]
pub struct MayaServerState {
...
impl MayaServerManager {
    pub fn snapshot_locked(state: &mut MayaServerState) -> MayaServerInfo {
    ...
    pub fn stop_locked(state: &mut MayaServerState) {
